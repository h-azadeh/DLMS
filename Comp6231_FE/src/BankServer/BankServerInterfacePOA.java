        ...
        implements BankServerInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_openAccount(
        ...
        BankServer.CustomerAccount arg0_in = BankServer.CustomerAccountHelper.read(_is);

        String _arg_result = openAccount(arg0_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getLoan(
        ...
        boolean _arg_result = getLoan(arg0_in, arg1_in, arg2_in, arg3_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_printCustomerInfo(
        ...
        BankServer.CustomerAccount[] _arg_result = printCustomerInfo(arg0_in);

        _output = handler.createReply();
        BankServer.AccountsMapHelper.write(_output,_arg_result);
