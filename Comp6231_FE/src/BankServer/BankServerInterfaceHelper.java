...
public class BankServerInterfaceHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, BankServer.BankServerInterface t)
    {
     ...
     */
    public static BankServer.BankServerInterface extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return BankServer.BankServerInterfaceHelper.narrow( a.extract_Object() );
        }
     ...
     */
    public static BankServer.BankServerInterface read(org.omg.CORBA.portable.InputStream istream)
    {
        return(BankServer.BankServerInterface)istream.read_Object(BankServer._BankServerInterfaceStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, BankServer.BankServerInterface value)
    {
