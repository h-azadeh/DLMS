        ...
        implements BankServerInterface
{
    ...
    private final static Class _opsClass = BankServer.BankServerInterfaceOperations.class;

    /**
     * Operation openAccount
     */
    public String openAccount(BankServer.CustomerAccount account)
    {
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    ...
                    BankServer.CustomerAccountHelper.write(_output,account);
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                BankServer.BankServerInterfaceOperations _self = (BankServer.BankServerInterfaceOperations) _so.servant;
                try
                {
     ...
     */
    public BankServer.CustomerAccount[] printCustomerInfo(String bankName)
    {
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    ...
                    _output.write_string(bankName);
                    _input = this._invoke(_output);
                    BankServer.CustomerAccount[] _arg_ret = BankServer.AccountsMapHelper.read(_input);
                    return _arg_ret;
                }
                catch(org.omg.CORBA.portable.RemarshalException _exception)
                {
