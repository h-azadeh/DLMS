...
public class CustomerAccountHelper
{
    ...
    {
        a.insert_Streamable(new BankServer.CustomerAccountHolder(t));
    }
    ...
    public static BankServer.CustomerAccount extract( org.omg.CORBA.Any a )
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.orb.core.Any) {
            ...
            try {
                ...
                if ( s instanceof BankServer.CustomerAccountHolder )
                    return ( ( BankServer.CustomerAccountHolder ) s ).value;
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            BankServer.CustomerAccountHolder h = new BankServer.CustomerAccountHolder( read( a.create_input_stream() ) );
    ...
    {
        BankServer.CustomerAccount new_one = new BankServer.CustomerAccount();
