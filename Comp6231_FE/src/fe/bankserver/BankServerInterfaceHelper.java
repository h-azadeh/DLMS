...
public class BankServerInterfaceHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, fe.bankserver.BankServerInterface t)
    {
     ...
     */
    public static fe.bankserver.BankServerInterface extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return fe.bankserver.BankServerInterfaceHelper.narrow( a.extract_Object() );
        }
     ...
     */
    public static fe.bankserver.BankServerInterface read(org.omg.CORBA.portable.InputStream istream)
    {
        return(fe.bankserver.BankServerInterface)istream.read_Object(fe.bankserver._BankServerInterfaceStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, fe.bankserver.BankServerInterface value)
    {
