...
public class AccountHelper
{
    ...
    {
        a.insert_Streamable(new fe.bankserver.AccountHolder(t));
    }
    ...
    public static String[] extract( org.omg.CORBA.Any a )
    {
        ...
        if ( HAS_OPENORB && a instanceof org.openorb.orb.core.Any )
        {
            ...
            try
            {
                ...
                if ( s instanceof fe.bankserver.AccountHolder )
                {
                    return ( ( fe.bankserver.AccountHolder ) s ).value;
                }
            }
            catch ( org.omg.CORBA.BAD_INV_ORDER ex )
            {
            }
            fe.bankserver.AccountHolder h = new fe.bankserver.AccountHolder( read( a.create_input_stream() ) );
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc( id(), "Account", orb.create_array_tc( 100, orb.get_primitive_tc( org.omg.CORBA.TCKind.tk_string ) ) );
        }
        return _tc;
    }
    ...
    private final static String _id = "IDL:bankServer/Account:1.0";
